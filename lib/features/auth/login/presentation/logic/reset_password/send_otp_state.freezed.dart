...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SendOtpState<T>);
}
...
/// @nodoc
class $SendOtpStateCopyWith<T,$Res>  {
$SendOtpStateCopyWith(SendOtpState<T> _, $Res Function(SendOtpState<T>) __);
}


/// Adds pattern-matching-related methods to [SendOtpState].
extension SendOtpStatePatterns<T> on SendOtpState<T> {
...
class _Initial<T> implements SendOtpState<T> {
  const _Initial();
...
class Loading<T> implements SendOtpState<T> {
  const Loading();
...
class Success<T> implements SendOtpState<T> {
...
@override
String toString() {
  return 'SendOtpState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $SendOtpStateCopyWith<T, $Res> {
...
class Failed<T> implements SendOtpState<T> {
...
@override
String toString() {
  return 'SendOtpState<$T>.failed(error: $error)';
}
...
/// @nodoc
abstract mixin class $FailedCopyWith<T,$Res> implements $SendOtpStateCopyWith<T, $Res> {
