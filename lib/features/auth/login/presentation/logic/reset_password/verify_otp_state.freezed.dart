...
class _Initial<T> implements VerifyOtpState<T> {
  const _Initial();
...
class Failed<T> implements VerifyOtpState<T> {
...
@override
String toString() {
  return 'VerifyOtpState<$T>.failed(error: $error)';
}
...
/// @nodoc
abstract mixin class $FailedCopyWith<T,$Res> implements $VerifyOtpStateCopyWith<T, $Res> {
