...
class Failed<T> implements ResetPasswordState<T> {
...
@override
String toString() {
  return 'ResetPasswordState<$T>.failed(error: $error)';
}
...
/// @nodoc
abstract mixin class $FailedCopyWith<T,$Res> implements $ResetPasswordStateCopyWith<T, $Res> {
