...
class _ResetPasswordApiService implements ResetPasswordApiService {
  _ResetPasswordApiService(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  @override
  Future<OtpResponseModel> sendOtp(String lang, OtpRequestModel body) async {
  ...
  Future<ResetPasswordResponseModel> resetPassword(
    ...
    final _options = _setStreamType<ResetPasswordResponseModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '${lang}/ForgetPassword/ResetPassword',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
