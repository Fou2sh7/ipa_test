...
class Loading<T> implements ChangePasswordState<T> {
  const Loading();
...
class Success<T> implements ChangePasswordState<T> {
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $ChangePasswordStateCopyWith<T, $Res> {
...
class Failed<T> implements ChangePasswordState<T> {
...
@override
String toString() {
  return 'ChangePasswordState<$T>.failed(error: $error)';
}
...
/// @nodoc
abstract mixin class $FailedCopyWith<T,$Res> implements $ChangePasswordStateCopyWith<T, $Res> {
