...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( String languageCode)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Loaded() when loaded != null:
return loaded(_that.languageCode);case Error() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( String languageCode)  loaded,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case Initial():
return initial();case Loading():
return loading();case Loaded():
return loaded(_that.languageCode);case Error():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( String languageCode)?  loaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Loaded() when loaded != null:
...
class Initial implements LanguageState {
  const Initial();
...
class Loading implements LanguageState {
  const Loading();
...
class Loaded implements LanguageState {
  const Loaded(this.languageCode);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Loaded&&(identical(other.languageCode, languageCode) || other.languageCode == languageCode));
}
...
@override
String toString() {
  return 'LanguageState.loaded(languageCode: $languageCode)';
}
...
/// @nodoc
abstract mixin class $LoadedCopyWith<$Res> implements $LanguageStateCopyWith<$Res> {
...
class Error implements LanguageState {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $LanguageStateCopyWith<$Res> {
