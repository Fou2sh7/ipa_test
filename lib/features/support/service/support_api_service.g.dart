...
class _SupportApiService implements SupportApiService {
  _SupportApiService(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  @override
  Future<ContactsResponse> getContacts(String lang) async {
  ...
  @override
  Future<FAQResponse> getFaqs(String lang) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
