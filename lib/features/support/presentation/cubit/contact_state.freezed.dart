...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( ContactsResponse data)?  loaded,TResult Function( String message)?  failed,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( ContactsResponse data)  loaded,required TResult Function( String message)  failed,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( ContactsResponse data)?  loaded,TResult? Function( String message)?  failed,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Loaded() when loaded != null:
...
class _Initial implements ContactState {
  const _Initial();
...
class Loading implements ContactState {
  const Loading();
...
class Loaded implements ContactState {
  const Loaded(this.data);
  

 final  ContactsResponse data;
...
@override
String toString() {
  return 'ContactState.loaded(data: $data)';
}
...
/// @nodoc
abstract mixin class $LoadedCopyWith<$Res> implements $ContactStateCopyWith<$Res> {
...
class Failed implements ContactState {
...
@override
String toString() {
  return 'ContactState.failed(message: $message)';
}
...
/// @nodoc
abstract mixin class $FailedCopyWith<$Res> implements $ContactStateCopyWith<$Res> {
