...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( HomeResponse model)?  loaded,TResult Function( String message)?  failed,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( HomeResponse model)  loaded,required TResult Function( String message)  failed,}) {final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( HomeResponse model)?  loaded,TResult? Function( String message)?  failed,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Loaded() when loaded != null:
...
class Loading implements HomeCubitState {
  const Loading();
...
class Loaded implements HomeCubitState {
...
@override
String toString() {
  return 'HomeCubitState.loaded(model: $model)';
}
...
/// @nodoc
abstract mixin class $LoadedCopyWith<$Res> implements $HomeCubitStateCopyWith<$Res> {
...
class Failed implements HomeCubitState {
...
@override
String toString() {
  return 'HomeCubitState.failed(message: $message)';
}
...
/// @nodoc
abstract mixin class $FailedCopyWith<$Res> implements $HomeCubitStateCopyWith<$Res> {
